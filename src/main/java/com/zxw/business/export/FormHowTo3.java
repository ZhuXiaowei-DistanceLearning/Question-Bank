...
public class FormHowTo3 {
    ...
    public static void main(String[] args) {
        ...
        FormHowTo3.builder()
                .setCallBack(new DateCsvCallBack() {
                    ...
                    @Override
                    public void doInCell(String cellReference, String formattedValue, XSSFComment comment) {
    ...
    public void merge() {
        ...
        this.file1 = new File(targetPath + "/cp_" + currentDate.getYear() + "-" + this.month + "_" + this.number + "." + fileExtension);
        try {
...
//            }
        ...
        public void cell(String cellReference, String formattedValue,
            ...
            if (callBack != null) {
                callBack.doInCell(cellReference, formattedValue, comment);
            }
            if (!cellReference.equals("A1")) {
                if (cellReference.toString().substring(0, 1).equals("A")) {
                    if (day < 10) {
                        formattedValue = formattedValue.substring(0, 10) + monthString + "0" + day + formattedValue.substring(14);
                    } else {
                        formattedValue = formattedValue.substring(0, 10) + monthString + day + formattedValue.substring(14);
                    }
                }
            }
            if (!cellReference.equals("K1")) {
                if (cellReference.toString().substring(0, 1).equals("K")) {
                    if (day < 10) {
                        formattedValue = formattedValue.substring(0, 4) + monthString + "0" + day + formattedValue.substring(8);
                    } else {
                        formattedValue = formattedValue.substring(0, 4) + monthString + day + formattedValue.substring(9);
                    }
    ...
    public interface DateCsvCallBack {
        ...
        void doInCell(String cellReference, String formattedValue,
                      XSSFComment comment);
    }

    public FormHowTo3(int month, String targetPath, String oddPath, String evenPath, String febPath, DateCsvCallBack callBack, String fileExtension) {
        this.month = month;
    ...
    static class Builder {
        ...
        public void start() {
            FormHowTo3 formHowTo3 = new FormHowTo3(month, targetPath, oddPath, evenPath, FebPath, callBack, fileExtension);
            formHowTo3.merge();
        }
    }
}
