...
public class BackTrace {
    ...
    public static void main(String[] args) {
        ...
        Assert.isTrue(2 == backTrace.subarraySum(LeetCodeWrapper.stringToIntegerArray("[1,1,1]"), 2));
...
//        return 0;
    ...
    public int subarraySumBackTrack(int[] nums, int k, int start) {
        // 把它俩转成字符串才能作为哈希表的键
        ...
        int i = subarraySumBackTrack(nums, k1, start + 1);
        memo.put(key, memo.getOrDefault(key, 0));
        return i;
    }
